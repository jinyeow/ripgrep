...
fn app<F>(next_line_help: bool, doc: F) -> App<'static, 'static>
    ...
    App::new("ripgrep")
        ...
        .arg(arg("pattern")
             .required_unless_one(&[
                "files", "help-short", "help", "regexp", "type-list",
                "version",
             ]))
        ...
        .arg(flag("files")
             ...
             .conflicts_with_all(&["regexp", "type-list"]))
        .arg(flag("type-list")
             .conflicts_with_all(&["files", "pattern", "regexp"]))
    ...
    static ref USAGES: HashMap<&'static str, Usage> = {
        ...
        doc!(h, "ignore-file",
             ...
             "Specify additional ignore files for filtering file paths. \
              ...
              have lower precedence than all other ignore file types. When \
